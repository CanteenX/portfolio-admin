...
export const DOC_TABS = [
    ...
    sections: [
      {
        ...
        body: `
          ...
          <ul>
            ...
            <li>Control who can access what via custom roles and permissions</li>
      ...
      },
      {
        ...
        body: `
          <ul>
            ...
            <li><strong>Custom Roles</strong> — <code>/settings/custom-roles</code></li>
    ...
    sections: [
      ...
      },
      {
        ...
        body: `
          ...
          <ul>
            <li><strong>User info</strong> — email, role, custom role (if any)</li>
            <li><strong>Permissions</strong> — flat permission strings for middleware checks</li>
            <li><strong>Enabled modules</strong> — which of the 13 modules are active</li>
            ...
            <li><strong>Structured permissions</strong> — per-menu 5-action permission matrix (for admin users with custom roles)</li>
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "custom-roles", heading: "Custom Roles", body: `<p>Create and manage granular access control:</p><ol><li>Go to <strong>Settings &gt; Custom Roles</strong></li><li>Click <strong>Create Role</strong> and name it</li><li>Click <strong>Permissions</strong> to open the Permission Matrix</li><li>Toggle permissions for each menu item across 5 actions: read, create, update, delete, export</li><li>Save the role and assign to users</li></ol><p><strong>Route:</strong> <code>/settings/custom-roles</code></p>` },
      { id: "permission-matrix", heading: "Permission Matrix", body: `<p>A visual grid to configure what each custom role can do:</p><table><thead><tr><th>Action</th><th>Description</th></tr></thead><tbody><tr><td><strong>Read</strong></td><td>View the page and its data</td></tr><tr><td><strong>Create</strong></td><td>Create new records</td></tr><tr><td><strong>Update</strong></td><td>Edit existing records</td></tr><tr><td><strong>Delete</strong></td><td>Remove records</td></tr><tr><td><strong>Export</strong></td><td>Export data (CSV, etc.)</td></tr></tbody></table><p><strong>Bulk toggles:</strong> Column header, group header, and row toggle buttons available.</p>` },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "comp-permgate", heading: "PermissionGate", body: `<p>Conditionally renders children based on page permissions: <code>&lt;PermissionGate action="delete"&gt;...&lt;/PermissionGate&gt;</code></p>` },
    ],
  },
  {
    key: "api",
  ...
  },
  {
    ...
    label: "How To Use",
    sections: [
      { id: "howto-create-role", heading: "Create a Custom Role", body: `<ol><li>Log in as Super Admin</li><li>Navigate to <strong>Settings &gt; Custom Roles</strong></li><li>Click <strong>Create Role</strong></li><li>Enter a role name (e.g., "Sales Manager")</li><li>Save the role</li><li>Click <strong>Permissions</strong> on the role</li><li>Check the boxes for allowed actions in the Permission Matrix</li><li>Click <strong>Save Permissions</strong></li></ol>` },
      { id: "howto-assign-role", heading: "Assign a Role to a User", body: `<ol><li>Call <code>PUT /api/v1/system/users/:userId/custom-role</code></li><li>Pass <code>{ "customRoleId": "the-role-id" }</code></li><li>To remove, pass <code>{ "customRoleId": null }</code></li></ol>` },
